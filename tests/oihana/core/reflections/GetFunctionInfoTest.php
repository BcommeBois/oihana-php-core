...
use oihana\core\reflections\samples\SampleClass;
...
class GetFunctionInfoTest extends TestCase
{
    ...
    public function testStaticMethod() :void
    {
        ...
        $info = getFunctionInfo('oihana\\core\\reflections\\samples\\SampleClass::staticMethod' );
        $this->assertIsArray($info);
        $this->assertSame('oihana\\core\\reflections\\samples\\SampleClass::staticMethod', $info['name']);
        $this->assertSame('oihana\\core\\reflections\\samples', $info['namespace']);
    ...
    public function testInstanceMethodArray() :void
    {
        ...
        $this->assertIsArray($info);
        $this->assertSame('oihana\\core\\reflections\\samples\\SampleClass::instanceMethod', $info['name']);
    }
