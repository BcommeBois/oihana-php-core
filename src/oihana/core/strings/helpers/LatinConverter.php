...
{
    /**
     * Mapping of accented Latin characters to simplified ASCII.
     */
    public const array LATINS =
    [
        'Á'=> 'A',
        'Ă'=> 'A',
        'Ắ'=> 'A',
     ...
     *
     * @param string $input The input string containing accented Latin characters.
     * @return string The transliterated string with ASCII characters only.
     *
     * @example
     * ```php
     * echo LatinConverter::toAscii('Café Münsterländer'); // Outputs: Cafe Munsterlander
     * echo LatinConverter::toAscii('¡Hola señor!');      // Outputs: !Hola senor!
     * ```
     */
    public static function toAscii( string $input ): string
    {
        return strtr( $input, self::LATINS );
    }
}