 ...
 *
 * This function provides a convenient way to ensure an expression is
 * surrounded by spaces. The behavior depends on the type of `$expression`:
 *
 ...
 * - **If `$useSpaces` is `false`**, the expression is returned as-is
 ...
 *
 * @return string The expression wrapped with spaces if `$useSpaces` is `true`; otherwise the original expression as string.
 *
 * @example
 * ```php
